...
class MainWindow(QTabWidget):
    ...
    def __init__(self):
        ...
        self.setWindowTitle('基于卷积神经网络的中草药分类系统')
        # 模型初始化
        self.model = tf.keras.models.load_model("./train/EfficientNetV2S_Att_No_Aug_2023-07-16-13-28-31_best.h5")
    ...
    def initUI(self):
        ...
        about_title = QLabel('欢迎使用基于卷积神经网络的中草药分类系统')
