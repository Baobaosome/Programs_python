...
model = torch.load('yolov5s.pt', weights_only=False)
...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    if single_cls:
        ...
        # 根据您的数据集类别数量设置
        if data_dict["nc"] == 3:
            names = {0: "血小板", 1: "红细胞", 2: "白细胞"}
        else:
            names = data_dict["names"]  # 回退到原始名称
...
def parse_opt(known=False):
    ...
    parser.add_argument("--cfg", type=str, default="models/yolov5s.yaml", help="model.fyaml path")
